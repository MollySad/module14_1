...
bot = Bot(token='7246483517:AAErvZzrVf2eupXWnR3au8t0bfutS9JVtFs')
...
kb3 = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardMarkup(text="Продукт 1", callback_data="product_buying"),
         InlineKeyboardMarkup(text="Продукт 2", callback_data="product_buying"),
         InlineKeyboardMarkup(text="Продукт 3", callback_data="product_buying"),
         InlineKeyboardMarkup(text="Продукт 4", callback_data="product_buying")]
    ]
)
